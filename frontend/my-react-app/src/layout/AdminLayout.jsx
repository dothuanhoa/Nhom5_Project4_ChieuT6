...
export default function AdminLayout() {
  ...
  const menuItems = [
    ...
    { path: "/admin/students", icon: Users, label: "Danh Sách Sinh Viên" },
    { path: "/admin/classes", icon: GraduationCap, label: "Danh Sách Lớp Học" },
    { path: "/admin/register-face", icon: UserPlus, label: "Đăng Ký Khuôn Mặt" },
    { path: "/admin/attendance", icon: History, label: "Lịch sử Điểm Danh" },
  ];
            ...
            <div className="flex items-center gap-3 cursor-pointer group">
              <div className="text-right hidden sm:block">
                ...
                <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-0.5">
                  {user?.role === "admin" ? "Hệ thống" : "Admin"}
                </div>
              </div>
